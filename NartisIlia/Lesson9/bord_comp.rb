module BordComp
 attr_accessor :car_brand, :weight, :value_eng
    ...
    def status
    {"car brand"=>@car_brand,"type fuel"=> @type_eng, "weight"=>@weight, "value engine"=>@value_eng, "value tank"=> @value_tank, "value fuel"=>@value_fuel, "srednii rashod topliva"=> average_fuel(1), "ostalosi proehati"=> distance_to_next(1), "koeff topliva v bake"=> ratio_fuel,"material kuzova"=>self.class::MATERIAL}
    end
end
